...
var Login = function (_a) {
    ...
    var _b = react.exports.useState({ password: '' }), loginData = _b[0], setLoginData = _b[1];
    var _c = react.exports.useState(false), invalidCredentials = _c[0], setInvalidCredentials = _c[1];
    var _d = react.exports.useState(false), loadingSpinner = _d[0], setLoadingSpinner = _d[1];
