...
var Login = function (_a) {
    ...
    var _b = React.useState({ password: '' }), loginData = _b[0], setLoginData = _b[1];
    var _c = React.useState(false), invalidCredentials = _c[0], setInvalidCredentials = _c[1];
    var _d = React.useState(false), loadingSpinner = _d[0], setLoadingSpinner = _d[1];
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: 'row content-center' },
            React__default["default"].createElement("div", { className: 'col items-center card' },
                loadingSpinner && React__default["default"].createElement("div", { className: 'loading-spinner', "data-testid": "loading-spinner" },
                    React__default["default"].createElement("div", { className: "lds-dual-ring" })),
                React__default["default"].createElement("h3", null,
                    " ", headline !== null && headline !== void 0 ? headline : React__default["default"].createElement(React__default["default"].Fragment, null, "Login")),
                React__default["default"].createElement("table", null,
                    React__default["default"].createElement("tbody", null,
                        React__default["default"].createElement("tr", null,
                            React__default["default"].createElement("td", null, ((credentials === null || credentials === void 0 ? void 0 : credentials.username) || (checkCredentials === null || checkCredentials === void 0 ? void 0 : checkCredentials.username) || (formEvents === null || formEvents === void 0 ? void 0 : formEvents.onUsernameChange)) && React__default["default"].createElement("label", null,
                                " ",
                                React__default["default"].createElement("b", null, "Username:"))),
                            React__default["default"].createElement("td", null, ((credentials === null || credentials === void 0 ? void 0 : credentials.username) || (checkCredentials === null || checkCredentials === void 0 ? void 0 : checkCredentials.username) || (formEvents === null || formEvents === void 0 ? void 0 : formEvents.onUsernameChange)) &&
                                React__default["default"].createElement("input", { onChange: handleUserNameChange, "data-testid": "username-input" }))),
                        React__default["default"].createElement("tr", null,
                            React__default["default"].createElement("td", null,
                                React__default["default"].createElement("b", null, "Password:")),
                            React__default["default"].createElement("td", null,
                                React__default["default"].createElement("input", { type: "password", onChange: handlePasswordChange, "data-testid": "password-input" }))))),
                React__default["default"].createElement("button", { onClick: handleLogin, "data-testid": "login-button" }, "Login"),
                (invalidCredentials || (formEvents === null || formEvents === void 0 ? void 0 : formEvents.showLoginFailedMessage)) &&
                    React__default["default"].createElement("p", { className: 'login-faild-message', "data-testid": "login-failed-message" },
                        " ", loginFailedMessage !== null && loginFailedMessage !== void 0 ? loginFailedMessage : React__default["default"].createElement("span", null, "Invalid credentials.")))));
};
